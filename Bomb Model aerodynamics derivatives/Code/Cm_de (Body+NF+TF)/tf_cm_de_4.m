%% δe = +10 [6698_Bomb Model-II_Body_NF_TF_+10]

k1 = wind_tunnel_data(41);
k2 = wind_tunnel_data(42);
k3 = wind_tunnel_data(43);
...
CL41 = sind(alpha)*Cfx1 - cosd(alpha)*Cfz1;
CL42 = sind(alpha)*Cfx2 - cosd(alpha)*Cfz2;
CL43 = sind(alpha)*Cfx3 - cosd(alpha)*Cfz3;

CD41 = -cosd(alpha)*Cfx1 - sind(alpha)*Cfz1;
CD42 = -cosd(alpha)*Cfx2 - sind(alpha)*Cfz2;
CD43 = -cosd(alpha)*Cfx3 - sind(alpha)*Cfz3;
