%% δe = -10 [6699_Bomb Model-II_Body_NF_TF_-10]

k1 = wind_tunnel_data(51);
k2 = wind_tunnel_data(52);
k3 = wind_tunnel_data(53);
...
CL51 = sind(alpha)*Cfx1 - cosd(alpha)*Cfz1;
CL52 = sind(alpha)*Cfx2 - cosd(alpha)*Cfz2;
CL53 = sind(alpha)*Cfx3 - cosd(alpha)*Cfz3;

CD51 = -cosd(alpha)*Cfx1 - sind(alpha)*Cfz1;
CD52 = -cosd(alpha)*Cfx2 - sind(alpha)*Cfz2;
CD53 = -cosd(alpha)*Cfx3 - sind(alpha)*Cfz3;
