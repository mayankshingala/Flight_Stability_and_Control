%% δe = -5 [6697_Bomb Model-II_Body_NF_TF_-5]

k1 = wind_tunnel_data(31);
k2 = wind_tunnel_data(32);
k3 = wind_tunnel_data(33);
...
CL31 = sind(alpha)*Cfx1 - cosd(alpha)*Cfz1;
CL32 = sind(alpha)*Cfx2 - cosd(alpha)*Cfz2;
CL33 = sind(alpha)*Cfx3 - cosd(alpha)*Cfz3;

CD31 = -cosd(alpha)*Cfx1 - sind(alpha)*Cfz1;
CD32 = -cosd(alpha)*Cfx2 - sind(alpha)*Cfz2;
CD33 = -cosd(alpha)*Cfx3 - sind(alpha)*Cfz3;
