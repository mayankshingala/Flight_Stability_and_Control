%% δe = -15 [6689_Bomb Model-II_Body_TF_-15]

k1 = wind_tunnel_data(71);
k2 = wind_tunnel_data(72);
k3 = wind_tunnel_data(73);
...
CL71 = sind(alpha)*Cfx1 - cosd(alpha)*Cfz1;
CL72 = sind(alpha)*Cfx2 - cosd(alpha)*Cfz2;
CL73 = sind(alpha)*Cfx3 - cosd(alpha)*Cfz3;

CD71 = -cosd(alpha)*Cfx1 - sind(alpha)*Cfz1;
CD72 = -cosd(alpha)*Cfx2 - sind(alpha)*Cfz2;
CD73 = -cosd(alpha)*Cfx3 - sind(alpha)*Cfz3;
