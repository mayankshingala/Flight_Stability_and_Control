%% δe = -20 [6691_Bomb Model-II_Body_TF_-20]

k1 = wind_tunnel_data(91);
k2 = wind_tunnel_data(92);
k3 = wind_tunnel_data(93);
...
CL91 = sind(alpha)*Cfx1 - cosd(alpha)*Cfz1;
CL92 = sind(alpha)*Cfx2 - cosd(alpha)*Cfz2;
CL93 = sind(alpha)*Cfx3 - cosd(alpha)*Cfz3;

CD91 = -cosd(alpha)*Cfx1 - sind(alpha)*Cfz1;
CD92 = -cosd(alpha)*Cfx2 - sind(alpha)*Cfz2;
CD93 = -cosd(alpha)*Cfx3 - sind(alpha)*Cfz3;
