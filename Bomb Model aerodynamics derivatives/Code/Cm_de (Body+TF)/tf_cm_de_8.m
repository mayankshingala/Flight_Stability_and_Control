%% δe = +20 [6689_Bomb Model-II_Body_TF_-15]

k1 = wind_tunnel_data(81);
k2 = wind_tunnel_data(82);
k3 = wind_tunnel_data(83);
...
CL81 = sind(alpha)*Cfx1 - cosd(alpha)*Cfz1;
CL82 = sind(alpha)*Cfx2 - cosd(alpha)*Cfz2;
CL83 = sind(alpha)*Cfx3 - cosd(alpha)*Cfz3;

CD81 = -cosd(alpha)*Cfx1 - sind(alpha)*Cfz1;
CD82 = -cosd(alpha)*Cfx2 - sind(alpha)*Cfz2;
CD83 = -cosd(alpha)*Cfx3 - sind(alpha)*Cfz3;
