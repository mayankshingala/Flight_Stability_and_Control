%% δe = -25 [6693_Bomb Model-II_Body_TF_-25]

k1 = wind_tunnel_data(111);
k2 = wind_tunnel_data(112);
k3 = wind_tunnel_data(113);
...
CL111 = sind(alpha)*Cfx1 - cosd(alpha)*Cfz1;
CL112 = sind(alpha)*Cfx2 - cosd(alpha)*Cfz2;
CL113 = sind(alpha)*Cfx3 - cosd(alpha)*Cfz3;

CD111 = -cosd(alpha)*Cfx1 - sind(alpha)*Cfz1;
CD112 = -cosd(alpha)*Cfx2 - sind(alpha)*Cfz2;
CD113 = -cosd(alpha)*Cfx3 - sind(alpha)*Cfz3;
