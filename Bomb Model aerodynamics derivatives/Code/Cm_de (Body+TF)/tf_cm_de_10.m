%% δe = +25 [6692_Bomb Model-II_Body_TF_+25]

k1 = wind_tunnel_data(101);
k2 = wind_tunnel_data(102);
k3 = wind_tunnel_data(103);
...
CL101 = sind(alpha)*Cfx1 - cosd(alpha)*Cfz1;
CL102 = sind(alpha)*Cfx2 - cosd(alpha)*Cfz2;
CL103 = sind(alpha)*Cfx3 - cosd(alpha)*Cfz3;

CD101 = -cosd(alpha)*Cfx1 - sind(alpha)*Cfz1;
CD102 = -cosd(alpha)*Cfx2 - sind(alpha)*Cfz2;
CD103 = -cosd(alpha)*Cfx3 - sind(alpha)*Cfz3;
