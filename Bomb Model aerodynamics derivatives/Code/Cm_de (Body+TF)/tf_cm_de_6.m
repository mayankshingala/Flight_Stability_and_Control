%% δe = +15 [6687_Bomb Model-II_Body_TF_+15]

k1 = wind_tunnel_data(61);
k2 = wind_tunnel_data(62);
k3 = wind_tunnel_data(63);
...
CL61 = sind(alpha)*Cfx1 - cosd(alpha)*Cfz1;
CL62 = sind(alpha)*Cfx2 - cosd(alpha)*Cfz2;
CL63 = sind(alpha)*Cfx3 - cosd(alpha)*Cfz3;

CD61 = -cosd(alpha)*Cfx1 - sind(alpha)*Cfz1;
CD62 = -cosd(alpha)*Cfx2 - sind(alpha)*Cfz2;
CD63 = -cosd(alpha)*Cfx3 - sind(alpha)*Cfz3;
